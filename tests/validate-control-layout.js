...
["steps-text-size", "operation-style", "bar-style", "bar-shading"].forEach(setting => {
...
assert(playerHtml.includes('exploded-algebra-tool.js?v=20260924-classic-bars-restored'));
