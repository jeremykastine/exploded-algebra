...
assert(playerJs.includes('setChildAlignment(SETTINGS.childAlignment === "end" ? "center" : "end", true)'));
...
assert(playerHtml.includes('exploded-algebra-tool.js?v=20260924-child-alignment'));
