...
assert(playerHtml.includes('.builder-keypad-panel .builder-inv-button { grid-column: 3; grid-row: 2; }') && playerHtml.includes('.builder-keypad-panel .builder-move-up-button { grid-column: 3; grid-row: 1; }'), "Move Up and Inverse must top the column beside the number pad");
...
assert(playerJs.includes("function cycleDirectBuilderOperationToLowestLevel") && playerJs.includes("cloneBuilderMoveCycle(builder.moveCycle)"), "Move Up must cycle from the highest level back to its lowest placement");
