...
assert(playerHtml.includes('.builder-keypad-panel .builder-variable-button { grid-column: 3; grid-row: 1; }'), "The x button must occupy Peek's former top position");
assert(playerHtml.includes('.builder-keypad-panel .builder-inv-button { grid-column: 4; grid-row: 1; }') && playerHtml.includes('.builder-keypad-panel .builder-exit-inv-button { grid-column: 4; grid-row: 2; }'), "Inverse and Exit Inverse must top the column beside the number pad");
assert(playerHtml.includes('.builder-keypad-panel .builder-sum-button { grid-column: 4; grid-row: 4; }') && playerHtml.includes('.builder-keypad-panel .builder-prod-button { grid-column: 4; grid-row: 3; }'), "Addition and multiplication must bottom the column beside the number pad");
assert(playerHtml.includes('button.builder-submit-button {\n            grid-column: 2;\n            grid-row: 2 / span 3;') && playerHtml.includes('button.builder-review-button {\n            grid-column: 2;\n            grid-row: 1;'), "Peek must sit above a three-row Submit button");
assert(playerHtml.includes('.builder-keypad-panel .builder-zoom-in-button { grid-column: 3; grid-row: 2; }') && playerHtml.includes('.builder-keypad-panel .builder-reset-view-button { grid-column: 3; grid-row: 4; }'), "Builder zoom and reset controls must sit below x");
