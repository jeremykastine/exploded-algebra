...
assert(playerHtml.includes('.builder-keypad-panel .builder-sum-button { grid-column: 3; grid-row: 5; }') && playerHtml.includes('.builder-keypad-panel .builder-prod-button { grid-column: 4; grid-row: 5; }'), "Addition and multiplication must sit one row above the view controls");
assert(playerHtml.includes('button.builder-submit-button {\n            grid-column: 1;\n            grid-row: 5;') && playerHtml.includes('button.builder-review-button {\n            grid-column: 2;\n            grid-row: 5;'), "Submit and Review must sit one row above the view controls");
assert(playerHtml.includes('.builder-keypad-panel .builder-pan-button { grid-column: 1; grid-row: 6; }') && playerHtml.includes('.builder-keypad-panel .builder-reset-view-button { grid-column: 4; grid-row: 6; }'), "Builder pan, zoom, and reset controls must occupy the bottom row left of the number pad");
...
assert(playerHtml.includes('body.left-handed .builder-keypad-panel .builder-prod-button { grid-column: 4; grid-row: 5; }') && playerHtml.includes('body.left-handed .builder-keypad-panel .builder-submit-button { grid-column: 7; grid-row: 5; }') && playerHtml.includes('body.left-handed .builder-keypad-panel .builder-pan-button { grid-column: 7; grid-row: 6; }'), "Left-handed mode must mirror the complete keypad cluster");
