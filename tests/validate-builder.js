...
assert(playerHtml.includes('.builder-keypad-panel .builder-variable-button { grid-column: 5; grid-row: 1; }'), "x must sit above the Builder view controls in the second column from the right");
...
assert(playerHtml.includes('.builder-keypad-panel .builder-inv-button { grid-column: 4; grid-row: 4; }') && !playerHtml.includes('.builder-move-up-button'), "Inverse must occupy the lower-right corner of the shifted number pad");
assert(playerHtml.includes('[data-builder-action="digit"][data-value="7"] { grid-column: 2; grid-row: 1; }') && playerHtml.includes('[data-builder-action="digit"][data-value="9"] { grid-column: 4; grid-row: 1; }'), "The number pad must occupy the three middle columns");
...
assert(playerHtml.includes('.builder-keypad-panel .builder-zoom-in-button { grid-column: 5; grid-row: 2; }') && playerHtml.includes('.builder-keypad-panel .builder-reset-view-button { grid-column: 5; grid-row: 4; }'), "Builder zoom and reset controls must fill the bottom three cells of the second column from the right");
