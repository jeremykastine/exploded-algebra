...
assert(playerHtml.includes('.builder-keypad-panel .builder-variable-button { grid-column: 2; grid-row: 1; }'), "x must occupy the top cell of the column left of the number pad");
...
assert(playerHtml.includes('M1 100 H500') && playerHtml.includes('M1 200 H599') && playerHtml.includes('M1 300 H100 M200 300 H500'), "The Builder grid overlay must preserve both double-height buttons and the double-height Submit cell");
assert(playerHtml.includes('.builder-keypad-panel .builder-undo-button { grid-column: 2; grid-row: 2; }') && playerHtml.includes('button.builder-submit-button {\n            grid-column: 2;\n            grid-row: 3 / span 2;'), "Backspace must sit below x and Submit must fill the bottom half of their column");
