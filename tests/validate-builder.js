...
assert(playerHtml.includes('body.authoring-recording-session .workspace-toolbar [data-workspace-action="authoringCheckpoint"] { grid-column: 5 / span 2; grid-row: 4; }'), "Record Step must remain visible without overlapping the double-wide settings block");
