...
assert(playerHtml.includes('.builder-keypad-panel .builder-inv-button { grid-column: 3; grid-row: 2; }') && !playerHtml.includes('.builder-move-up-button'), "Inverse must retain its position while the former Move Up cell stays blank");
