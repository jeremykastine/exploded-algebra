...
assert(playerHtml.includes('button.builder-submit-button {\n            grid-column: 2;\n            grid-row: 3 / span 4;') && playerHtml.includes('button.builder-review-button {\n            grid-column: 3;\n            grid-row: 3;'), "Submit must span four rows and Peek must sit above the three view controls");
assert(playerHtml.includes('.builder-keypad-panel .builder-zoom-in-button { grid-column: 3; grid-row: 4; }') && playerHtml.includes('.builder-keypad-panel .builder-reset-view-button { grid-column: 3; grid-row: 6; }'), "Builder zoom and reset controls must form the middle control column");
...
assert(playerHtml.includes('body.left-handed .builder-keypad-panel .builder-variable-button { grid-column: 3; grid-row: 2; }') && playerHtml.includes('body.left-handed .builder-keypad-panel .builder-submit-button { grid-column: 6; grid-row: 3 / span 4; }') && playerHtml.includes('body.left-handed .builder-keypad-panel .builder-review-button { grid-column: 5; grid-row: 3; }') && playerHtml.includes('body.left-handed .builder-keypad-panel .builder-zoom-in-button { grid-column: 5; grid-row: 4; }'), "Left-handed mode must mirror the complete keypad cluster");
