...
assert(builderJs.includes('placeholder="Pre-version"') && builderJs.includes('placeholder="Post-version"') && builderJs.includes('placeholder="Instruction (optional)"'), "Each candidate step must have pre-version, instruction, and post-version editing fields");
...
assert(builderCss.includes(".step-carousel-slide") && builderCss.includes(".step-carousel-navigation") && builderCss.includes(".step-math-preview"), "Phase 4 must style the carousel and its stacked previews");
